...
@Component({
  selector: 'app-get-doc-financ',
  templateUrl: './get-doc-financ.component.html',
  styleUrls: ['./get-doc-financ.component.css']
})
export class GetDocFinancComponent {
  dataSource: DocFinanc[] = [];
  public paramId!: any;
