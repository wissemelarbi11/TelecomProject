...
import { DocFinanc } from '../models/doc-financ';

@Injectable({
  providedIn: 'root'
})
export class DocFinancService {

  private apiUrl = 'http://localhost:3000/docFinanc';
  ...
  getOne(id: number): Observable<DocFinanc> {
    return this.httpClient.get<DocFinanc>(`${this.apiUrl}/${id}`);
  }
