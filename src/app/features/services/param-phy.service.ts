...
import { ParamPhy } from '../models/param-phy';

@Injectable({
  providedIn: 'root'
})
export class ParamPhyService {
  private apiUrl = 'http://localhost:3000/paramPhysique';
  ...
  getOne(id: number): Observable<ParamPhy> {
    return this.httpClient.get<ParamPhy>(`${this.apiUrl}/${id}`);
  }
