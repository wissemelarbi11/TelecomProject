...
import { TypeSupport } from '../models/type-support';

@Injectable({
  providedIn: 'root'
})
export class TypeSupportService {

  private apiUrl = 'http://localhost:3000/typeSupport';
  ...
  getOne(id: number): Observable<TypeSupport> {
    return this.httpClient.get<TypeSupport>(`${this.apiUrl}/${id}`);
  }
